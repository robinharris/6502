...
; *** Provides a short delay of around 56uS
SHORTDELAY:     PHA
                LDA             #$05           
                STA             DELAYCOUNTER    ; 14 cycles from here.  1 cycle = 1uS so 14uS per loop so 4 loops should be plenty
-               DEC             DELAYCOUNTER
                NOP
                BNE             -
                PLA
